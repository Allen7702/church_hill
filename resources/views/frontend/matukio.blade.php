    ...
    <section id="hero">
        <div class="hero-container d-flex flex-row">
            <div class="w-50 py-9 px-3">
                ...
                <h2 class="animate__animated animate__fadeInDown text-black-50" align="center">Matukio</h2>
                <p class="animate__animated animate__fadeInUp text-black-50  w-100" align="center">Karibu katika wavuti ya kanisa, usisite kusoma matukio mbalimbali.</p>
            </div>
                    ...
                    <div class="col-md-12 entries">
                            ...
                            @foreach ($data as $item)
                                <article class="entry">
                                    ...
                                    <h2 class="entry-title">
                                        <a href="{{url('matukio_guest')}}">{{$item->kichwa}}</a><hr>
                                    </h2>
                        ...
                        @else
                            <article class="entry">
                                ...
                                <h2 class="entry-title">
                                    <a href="{{url('matangazo_yetu')}}">Ukurasa wa Matukio</a>
                                </h2>
                                ...
                                <div class="entry-content">
                                    <p>
                                        Karibu katika ukurasa wa matukio mbalimbali kuhusiana na kanisa, ukurasa huu utahusisha matukio mbalimbali yanayohusiana na kanisa letu..
                                    </p>
