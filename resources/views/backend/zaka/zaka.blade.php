        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-7 text-right">
                    <button id="uploadBtn" class="btn btn-warning btn-sm mr-1">Pakia zaka</button>
                    ...
                    <a href="{{url('zaka_jumuiya_pdf')}}"><button class="btn btn-info btn-sm mr-1">PDF</button></a>
                    <a href="{{url('zaka_jumuiya_excel')}}"><button class="btn btn-info btn-sm mr-1">Excel</button></a>
                </div>
                ...
                <tbody>
                    @foreach ($data_zaka as $item)
                        <tr>
                            ...
                            <td>{{$loop->index+1}}</td>
                            <td>
                                <a href="{{url('zaka_jumuiya_husika',['id'=>$item->jumuiya])}}"><button class="view btn btn-sm btn-info mr-1" id="{{$item->id}}">Angalia</button></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
                 ...
                 <div class="modal fade" id="uploadModal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{route('zaka.zaka_import')}}" id="upload_form" method="POST" enctype="multipart/form-data">
                                    @csrf
