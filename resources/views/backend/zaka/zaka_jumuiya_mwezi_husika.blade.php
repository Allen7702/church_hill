        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    ...
                    <a href="{{url('zaka_jumuiya_mwezi_husika_pdf',['id'=>$jumuiya,'mwezi'=>$mwezi])}}"><button class="btn btn-info btn-sm mr-1">PDF</button></a>
                    <a href="{{url('zaka_jumuiya_mwezi_husika_excel',['id'=>$jumuiya,'mwezi'=>$mwezi])}}"><button class="btn btn-info btn-sm mr-1">Excel</button></a>
                </div>
                ...
                <tbody>
                    @foreach ($data_zaka as $item)
                        <tr>
                            ...
                            <td>{{$loop->index+1}}</td>
                            <td>
                                <a href="{{url('mwanafamilia',['id'=>$item->id])}}"><button class="btn btn-sm btn-info mr-1" id="{{$item->id}}">Angalia</button></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
                    ...
                    <div class="form-group" id="createMwanajumuiyaDiv">
                        ...
                        <select name="mwanajumuiya" class="form-control select2" id="mwanajumuiya">
                            ...
                            @foreach ($data_wanajumuiya as $row)
                                <option value="{{$row->jina_kamili}}">{{$row->jina_kamili}}-{{$row->jina_la_jumuiya}}</option>
                            @endforeach
                        </select>
                    </div>
        ...
        $('#jumuiya').change(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#mwanajumuiya').empty();
                    for (var i = 0; i < len; i++) {
                        var mwanajumuiya = data[i]['jina_kamili'];
