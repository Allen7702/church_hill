            ...
            <table class="table w-100" id="table">
                ...
                @foreach ($activities as $activity)
                    <tr>
                        ...
                        <td><a title="Onyesha kilichomo Taarifa" class="" href="{{route('activity.details', ['id' => $activity->causer->id, 'date' => date("Y-m-d",strtotime($activity->created_at))])}}">Onyesha Taarifa zaidi</a>
                        </td>
