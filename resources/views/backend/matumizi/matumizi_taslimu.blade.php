        ...
        <div class="card-body">
            <table class="table w-100" id="table">
                ...
                <tfoot>
                    ...
                    <th colspan="4">{{number_format($total_matumizi_taslimu,2)}}</th>
                </tfoot>
                <tbody>
                    @foreach ($data_taslimu as $item)
                        <tr>
...
<script>
    $("document").ready(function(){
        ...
        $('#mengineyoForm').on('submit', function(event){
            ...
            var data_url = "{{route('matumizi_taslimu.store')}}";

            if($('#action').val() == "Update")
            var data_url = "{{route('matumizi_taslimu.update')}}";
    ...
    $(document).on('click', '.delete', function (event) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    url: "/matumizi_taslimu/destroy/" + delete_id,
                    success: function (data) {
