        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    ...
                    <a href="{{url('michango_taslimu_jumuiya_husika_pdf',['id'=>$jumuiya])}}"><button class="btn btn-info btn-sm mr-2">PDF</button></a>
                    <a href="{{url('michango_taslimu_jumuiya_husika_excel',['id'=>$jumuiya])}}"><button class="btn btn-info btn-sm mr-0">Excel</button></a>
                </div>
                ...
                <tbody>
                    @foreach ($jumuiya_michango as $item)
                        <tr>
                            ...
                            <td>{{$loop->index+1}}</td>
                            <td>
                                <a href="{{url('michango_taslimu_jumuiya_mchango_husika',['id'=>$item->aina_ya_mchango,'jumuiya'=>$jumuiya])}}"><button class="btn btn-sm btn-info mr-1" id="{{$item->id}}">Angalia</button></a> 
                            </td>
                        </tr>
                    @endforeach
                </tbody>
