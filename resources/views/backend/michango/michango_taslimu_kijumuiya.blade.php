        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <a href="{{url('michango_taslimu')}}"><button class="btn btn-info btn-sm mr-1">Michango yote</button></a>
                    <button id="mchangoBtn" class="btn btn-info btn-sm mr-1">Ongeza mchango</i></button>
                    <a href="{{url('michango_taslimu_kijumuiya_pdf')}}"><button class="btn btn-info btn-sm mr-1">PDF</button></a>
                    <a href="{{url('michango_taslimu_kijumuiya_excel')}}"><button class="btn btn-info btn-sm mr-0">Excel</button></a>
                </div>
                ...
                <tbody>
                    @foreach ($jumuiya_data as $item)
                        <tr>
                            ...
                            <td>{{$loop->index+1}}</td>
                            <td>
                                <a href="{{url('michango_taslimu_jumuiya_husika',['id'=>$item->jina_la_jumuiya])}}"><button class="btn btn-sm btn-info mr-1" id="{{$item->id}}">Angalia</button></a> 
                            </td>
                        </tr>
                    @endforeach
                </tbody>
                ...
                <form id="mchangoForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group awamu_div" style="display:none" >
                                <label>Chagua awamu:</label>
                                <select name="awamu" id="awamu" class="form-control">
...
<script type="text/javascript">
    ...
    $("document").ready(function(){
           ...
           //check aina ya mchango and ahadi
           $('#aina_ya_mchango').change(function(){
         //   var value = $('#aina_ya_mchango').val();
            var value = $(this).find(":selected").val();
            var dataString = 'aina_ya_mchango='+ value;
           
$.ajax({
         
url:'{{route('ajax_check_michango_ahadi')}}',
type:"GET",
dataType: 'json',
data: dataString,
cache: true,
