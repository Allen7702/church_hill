        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    ...
                    <a href="{{url('michango_benki_jumuiya_mchango_husika_pdf',['mchango'=>$mchango,'jumuiya'=>$jumuiya])}}"><button class="btn btn-info btn-sm mr-1">PDF</button></a>
                    <a href="{{url('michango_benki_jumuiya_mchango_husika_excel',['mchango'=>$mchango,'jumuiya'=>$jumuiya])}}"><button class="btn btn-info btn-sm mr-0">Excel</button></a>
                </div>
        ...
        <div class="card-body">
            <table class="table w-100" id="table">
                ...
                <tbody>
                    ...
                    @foreach ($jumuiya_michango_husika as $item)
                        <tr>
                            <td>{{$loop->index+1}}</td>
