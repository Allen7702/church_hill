        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    ...
                    <a href="{{url('michango_benki_jumuiya_mwezi_mchango_husika_pdf',['mwezi'=>$mwezi,'jumuiya'=>$jumuiya,'mchango'=>$mchango])}}"><button class="btn btn-info btn-sm mr-1">PDF</button></a>
                    <a href="{{url('michango_benki_jumuiya_mwezi_mchango_husika_excel',['mwezi'=>$mwezi,'jumuiya'=>$jumuiya,'mchango'=>$mchango])}}"><button class="btn btn-info btn-sm mr-0">Excel</button></a>
                </div>
