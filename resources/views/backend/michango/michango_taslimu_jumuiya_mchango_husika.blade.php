    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    ...
                    <a href="{{url('michango_taslimu_jumuiya_mchango_husika_pdf',['mchango'=>$mchango,'jumuiya'=>$jumuiya])}}"><button class="btn btn-info btn-sm mr-2">PDF</button></a>
                    <a href="{{url('michango_taslimu_jumuiya_mchango_husika_excel',['mchango'=>$mchango,'jumuiya'=>$jumuiya])}}"><button class="btn btn-info btn-sm mr-0">Excel</button></a>
                </div>
        ...
        <div class="card-body">
            <table class="table_other table w-100" id="table">
                ...
                <tbody>
                    @foreach ($jumuiya_mchango_husika as $item)
                        <tr>
                            <td>{{$loop->index+1}}</td>
                            ...
                            <td>{{$loop->index+1}}</td>
                            <td>
                                <a href="{{url('mwanafamilia',['id'=>$item->mwanafamilia_id])}}"><button class="btn btn-sm btn-info mr-1" id="{{$item->id}}">Angalia</button></a> 
                            </td>
                        </tr>
                    @endforeach
                </tbody>
