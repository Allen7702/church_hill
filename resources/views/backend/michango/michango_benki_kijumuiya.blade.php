        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    ...
                    <a href="{{url('michango_benki_kijumuiya_pdf')}}"><button class="btn btn-info btn-sm mr-1">PDF</button></a>
                    <a href="{{url('michango_benki_kijumuiya_excel')}}"><button class="btn btn-info btn-sm mr-0">Excel</button></a>
                </div>
                ...
                <tbody>
                    ...
                    @foreach ($jumuiya_data as $item)
                        <tr>
                            ...
                            <td>{{$loop->index+1}}</td>
                            <td>
                                <a href="{{url('michango_benki_jumuiya_husika',['id'=>$item->jina_la_jumuiya])}}"><button class="btn btn-sm btn-info mr-1" id="{{$item->id}}">Angalia</button></a> 
                            </td>
                        </tr>
                    @endforeach
            ...
            <div class="modal-content">
                ...
                <form id="mchangoForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6 awamu_div" style="display:none" >
