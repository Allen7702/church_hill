        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    ...
                    <a href="{{url('michango_benki_mwezi_husika_pdf',['id'=>$mwezi])}}"><button class="btn btn-info btn-sm mr-1">PDF</button></a>
                    <a href="{{url('michango_benki_mwezi_husika_excel',['id'=>$mwezi])}}"><button class="btn btn-info btn-sm mr-0">Excel</button></a>
                </div>
                ...
                <tbody>
                    ...
                    @foreach ($michango_benki as $item)
                        <tr>
                            ...
                            <td>{{$loop->index+1}}</td>
                            <td>
                                <a href="{{url('michango_benki_jumuiya_mwezi_husika',['mwezi'=>$mwezi,'jumuiya'=>$item->jina_la_jumuiya])}}"><button class="btn btn-sm btn-info mr-1" id="{{$item->id}}">Angalia</button></a>
                            </td>
                        </tr>
                    @endforeach
