        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    ...
                    <a href="{{url('michango_benki_pdf')}}"><button class="btn btn-info btn-sm mr-2">PDF</button></a>
                    <a href="{{url('michango_benki_excel')}}"><button class="btn btn-info btn-sm mr-0">Excel</button></a>
                </div>
                ...
                <tbody>
                    @foreach ($michango_benki as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{url('mwanafamilia',['id'=>$item->mwanafamilia])}}"><button class="btn btn-sm btn-info mr-1">Angalia</button></a>
                                <button class="edit btn btn-sm btn-warning mr-1" id="{{$item->id}}">Badili</button>
                                <a href="{{url('michango_benki_risiti',['id'=>$item->id])}}"><button class="btn bg-info btn-sm mr-1"><i class="fas fa-fw fa-print text-white"></i></button></a>
