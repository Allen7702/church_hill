...
@section('content')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="d-flex justify-content-end">
                                ...
                                <button id="truncateBtn" class="btn btn-sm btn-warning mr-2">Futa wanafamilia wote</button>
                        ...
                        <tbody>
                            @foreach ($data_wanafamilia as $item)
                                <tr>
                                    ...
                                    <td><a href="{{url('familia/wanafamilia',['id'=>$item->familia_id])}}">{{$item->jina_la_familia}}</a></td>
                                    <td>
                ...
                <form id="chaguaForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="">Kiongozi wa familia:</label>
                            <select name="jina_la_familia" id="jina_la_familia" class="form-control select2" required>
                                @foreach ($data_familia as $item)
                                    <option value="{{$item->familia_id}}">{{$item->jina_la_familia}} - ({{$item->jina_la_jumuiya}})</option>
                                @endforeach
                            </select>
                        </div>

                        <div class="form-group">
                            <label for="">Wanafamilia:</label>
                            <select name="jina_kamili[]" id="jina_kamili" multiple="multiple" class="form-control select2" required>
    ...
    <div id="wanafamiliaModal" class="modal fade" data-backdrop="static" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
                ...
                <form id="wanafamiliaForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="jina_kamili" id="jina_kamili_update" class="form-control" placeholder="Jina la familia" required>
                        </div>
    ...
    <script>
        $("document").ready(function(){
            ...
            $('#chaguaBtn').on('click',function(){
                ...
                $('#jina_kamili').val('').trigger('change');
                $('.modal-title').text('Uundaji wa wanafamilia');
            ...
            $('#chaguaForm').on('submit', function(event){
                ...
                var data_url = "{{route('orodha_wanafamilia.orodha_wanafamilia_store')}}";
            ...
            $('#wanafamiliaForm').on('submit', function(event){
                ...
                var data_url = "{{route('orodha_wanafamilia.orodha_wanafamilia_update')}}";
            ...
            //function to handle the edition of wanafamilia update
            $(document).on('click','.edit', function(event){
                ...
                $.ajax({
                    url: "/orodha_wanafamilia/edit/" + id,
                    dataType: "JSON",
                    success: function(data){
                        $('#submitBtn').show();
                        ...
                        $('#jina_kamili_update').val(data.result.jina_kamili);
                        ...
                        $('#wanafamiliaModal').modal({backdrop: 'static',keyboard: false});
            ...
            $('#truncateBtn').on('click', function (event) {
                ...
                Swal.fire({
                    title: "Una uhakika?",
                    text: "Unakaribia kufuta wanafamilia wote! Majina ya wanafamilia yatarudishwa kwenye orodha ya majina..",
                    icon: 'warning',
                    type: 'warning',
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: "/orodha_wanafamilia/truncate/",
                            success: function (data) {
            ...
            $(document).on('click', '.delete', function (event) {
                ...
                Swal.fire({
                    title: "Una uhakika?",
                    text: "Unakaribia kufuta taarifa! Mwanafamilia atarejeshwa kwenye orodha ya majina..",
                    icon: 'warning',
                    type: 'warning',
                    showCancelButton: true,
                    confirmButtonText: 'Ndio, futa!',
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "/orodha_wanafamilia/destroy/" + delete_id,
                            success: function (data) {
            ...
            $('#tengenezaBtn').on('click', function (event) {
                ...
                Swal.fire({
                    ...
                    text: "Unakaribia kuwasilisha rasmi familia kwenye kanzidata ya mfumo! Mara baada ya zoezi wanafamilia watakua rasmi kwenye kanzidata..",
                    icon: 'warning',
                    type: 'warning',
                    showCancelButton: true,
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "/orodha_wanafamilia/tengeneza/",
                            success: function (data) {
