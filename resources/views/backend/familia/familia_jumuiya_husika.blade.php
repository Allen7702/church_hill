    ...
    <div class="card-header">
        <div class="row">
            ...
            <div class="col-md-7 text-right">
                ...
                <a href="{{url('familia_orodha_jumuiya_husika_pdf',['id'=>$jina_jumuiya])}}"><button class="btn btn-info btn-sm mr-1">PDF</button></a>
                <a href="{{url('familia_orodha_jumuiya_husika_excel',['id'=>$jina_jumuiya])}}"><button class="btn btn-info btn-sm mr-0">Excel</button></a>
            </div>
