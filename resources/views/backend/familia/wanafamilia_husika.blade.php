    ...
    <div class="card-header">
        <div class="row">
            ...
            <div class="col-md-8 text-right">
                ...
                <a href="{{url('wanafamilia_husika_pdf',['id'=>$familia_id])}}"><button class="btn btn-info btn-sm mr-1">PDF</button></a>
                <a href="{{url('wanafamilia_husika_excel',['id'=>$familia_id])}}"><button class="btn btn-info btn-sm mr-0">Excel</button></a>
            </div>
        </div>
    </div>
            ...
            <tbody>
                @foreach ($data_familia as $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{url('mwanafamilia',['id'=>$item->id])}}"><button class="view btn btn-sm btn-info mr-1" id="{{$item->id}}">Angalia</button></a>
            ...
            <form id="wanafamiliaForm">
                ...
                <div class="modal-body">
                    ...
                    <div id="firstDiv">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-12">
                                    ...
                                    <select name="jinsia" id="jinsia" class="form-control">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <label for="">Cheo cha familia:</label>
                    ...
                    <div class="text-center">
                        <small>Field zenye alama ya * lazima zijazwe</small>
                    </div>
