    ...
    <div class="card-header">
        <div class="row">
            ...
            <div class="col-md-6 text-right">
                ...
                <a href="{{url('sadaka_kuu_pdf')}}"><button class="btn btn-info btn-sm mr-2">PDF</button></a>
                <a href="{{url('sadaka_kuu_excel')}}"><button class="btn btn-info btn-sm mr-0">Excel</button></a>
            </div>
        </div>
    </div>
    <div class="card-body">
            ...
            <tbody>
                @foreach ($data_sadaka as $item)
                    <tr>
                        ...
                        <td>{{$loop->index+1}}</td>
                        <td>
                            <a href="{{url('sadaka_kuu_misa_husika',['id'=>$item->misa])}}"><button class="btn btn-sm btn-info">Angalia</button></a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
