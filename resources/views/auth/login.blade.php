                    ...
                    <div class="card-body px-lg-4 py-lg-5">
                        ...
                        @if($details != "" )
                            <div class="text-center py-0">
                                <img src="{{asset('/uploads/images/'.$details->photo)}}" width="100px" height="100px" alt="logo" class="navbar-brand rounded-circle">
                            </div>
                        @else
                        ...
                        <form role="form" method="POST" action="{{route('login')}}">
                            ...
                            <div class="form-group mb-3">
                                <div class="input-group input-group-merge input-group-alternative">
                                    ...
                                    <input class="form-control @error('mawasiliano') is-invalid @enderror" name="mawasiliano" pattern="[0-9]{10}" placeholder="Namba ya simu 0*********" type="text" required>
                                    @error('mawasiliano')
                            ...
                            <div class="form-group mb-3">
                                <div class="input-group input-group-merge input-group-alternative">
                                    ...
                                    <input class="form-control @error('password') is-invalid @enderror" name="password" placeholder="Nywila/Neno la siri" type="password" required>
                                    @error('password')
                                        <span class="invalid-feedback text-center" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
