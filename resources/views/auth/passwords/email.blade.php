                ...
                <div class="card border-0 mb-0">
                    ...
                    <div class="card-body px-lg-4 py-lg-5">
                        ...
                        <div class="text-center mb-3">
                            <h4 class="pt-4 text-primary" style="font-weight:bold;">{{strtoupper($details->centre_name)}}</h4>
                        </div>
                        ...
                        <form role="form" method="POST" action="{{route('login')}}">
                            ...
                            <div class="form-group mb-2">
                                <button type="submit" class="btn btn-primary w-100">Wasilisha taarifa</button>
                            </div>

                            <div class="form-group mb-2 text-center">
                                <a href="{{ route('login') }}" class="text-muted">Rudi mwanzo</a>
                            </div>
